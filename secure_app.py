...
def get_db_connection():
    return pymysql.connect(
        host="192.168.1.100",   # 🔴 ضع هنا الـ IP الحقيقي لسيرفر الاستضافة أونلاين (تجدها في cPanel)
        user="your_db_user",    # 🔴 اسم مستخدم قاعدة البيانات الذي أنشأته في الاستضافة أونلاين
        password="your_password", # 🔴 كلمة مرور مستخدم قاعدة البيانات في الاستضافة
        database="cyber_security_db", # اسم قاعدة البيانات
        charset="utf8mb4",
