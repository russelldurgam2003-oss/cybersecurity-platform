...
def get_db_connection():
    """
    الاتصال المباشر عَبْر سيرفر Streamlit Cloud وبناء الجداول تلقائياً بدون الحاجة للجهاز المحلي
    """
    ...
    # 🏗️ بناء الجداول ذاتياً عَبْر السيرفر السحابي مباشرة
    try:
        ...
        pass # إذا كانت الجداول مبنية سابقاً سيتخطى الأمر بسلاسة
