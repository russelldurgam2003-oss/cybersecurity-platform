...
def get_db_connection():
    """
    ضع هنا البيانات المستخرجة من حسابك في Aiven لربط منصة Streamlit بالسيرفر مباشرة
    """
    return pymysql.connect(
        host="mysql-15bd2f81-russelldurgam2003-5e67.a.aivencloud.com", # 🔴 رابط الـ Host من موقع Aiven
        port=26089,                                      # 🔴 رقم الـ Port الخاص بـ Aiven كقيمة رقمية
        user="avnadmin",                                 # اسم المستخدم الافتراضي هناك
        password="AVNS_Jsi7wWlmMkkCNrDTln8",
        database="defaultdb",                            # قاعدة البيانات الافتراضية المجهزة لك في السيرفر
        charset="utf8mb4",
