...
def get_db_connection():
    return pymysql.connect(
        host="IP_الاستضافة_الحقيقي_هنا",  
        user="اسم_المستخدم_الكامل_من_الاستضافة",  
        password="كلمة_المرور_التي_اخترتها_للمستخدم", 
        database="اسم_قاعدة_البيانات_الكامل_من_الاستضافة", 
        charset="utf8mb4",
